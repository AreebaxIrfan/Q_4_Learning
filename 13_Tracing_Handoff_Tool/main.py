...
def get_current_news()->str:
    ...
    """
    return News(title='Children Schools', description='Summer vacation will off student will go their school on time')
...
result = Runner.run_sync(
    agent,
    """ 
    hi , could you give me the greatest news forever?
